...
import Avatar from '../Avatar/Avatar'; // Importe o componente Avatar
  ...
  return (
    <aside className={styles.sidebar}>
      ...
      <div className={styles.profile}>
        <Avatar src="https://github.com/MarcDev18.png" /> {/* Use o componente Avatar aqui */}
        <strong>marc arise</strong>
